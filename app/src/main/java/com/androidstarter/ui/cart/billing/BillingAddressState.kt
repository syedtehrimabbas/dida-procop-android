...
class BillingAddressState @Inject constructor() : BaseState(), IBillingAddress.State {
    ...
    override val email: MutableLiveData<String> = MutableLiveData("syedtehrimabbas@gmail.com")
    override val country: MutableLiveData<String> = MutableLiveData()
    override val streetAddress: MutableLiveData<String> = MutableLiveData("Shan bhatti road, Lahore")
